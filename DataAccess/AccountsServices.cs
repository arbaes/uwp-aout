    ...
    public class AccountsServices
    {
        public async Task<bool> LogIn(String username, String password)
        {
            ...
            try
            {
                ...
                LoginResponseDAO responseO = (LoginResponseDAO)GetResponseService.HandleResponse(response, new LoginResponseDAO(), false);
        ...
        public async Task<bool> AddUser(Account user)
        {
            ...
            try
            {
                ...
                GetResponseService.HandleResponse(response, new AccountDAO(), false);
            }
            catch (HttpRequestException)
            {
                throw new GetDataException();
